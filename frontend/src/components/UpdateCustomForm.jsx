...
const  CreateCustomForm = ({fetchCustomers ,id, name , email , age , gender}) => {
    return (
        <>
            <Formik
                initialValues={{
                    ...
                    email: email,
                    age:age,
                    gender: gender, // added for our select
                }}
                ...
                onSubmit={(customer, { setSubmitting }) => {
                    ...
                    updateCustomer(customer , id)
                            .then(resp=>{
                                ...
                                notification("Acc: " +customer.name + " updated " ,
            ...
            >
                {({isValid , isSubmitting})=>( <Form>
                    <Stack spacing={"7px"}>
                        ...
                        <Button disabled={!isValid || isSubmitting } mt={"20px"} type="submit">Update</Button>
                    </Stack>
                </Form>
                )}
            </Formik>
